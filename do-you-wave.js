...
const tutorial_played = false;
const wave_noise = new Audio('foo.wav');
const wait_noise = new Audio('bar.wav');
const interval_delay = 1000;
let waves = 0;
let waits = 0;
let time_not_waving = 0;
const senario_count = senario.length;
let cur_senario = 0;
const debug = 0;
